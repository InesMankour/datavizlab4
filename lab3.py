...
st.title("Voici mon premier dataset")
...
<div class="max-w-sm rounded overflow-hidden shadow-lg mx-auto my-8">
    <img class="w-full" src="https://i.goopics.net/k7tp8l.png" alt="Sunset in the mountains">
    <div class="px-6 py-4">
    ...
    <div class="px-6 py-4">
      <span class="inline-block bg-gray-100 rounded-full px-3 py-1 text-sm font-semibold text-gray-600 mr-2">#Fun</span>
      <span class="inline-block bg-gray-100 rounded-full px-3 py-1 text-sm font-semibold text-gray-600 mr-2">#Meilleure matière</span>
...
st.markdown('Welcome to this **_really_ cool** dashboard.')
